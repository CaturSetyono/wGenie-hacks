import { arbitrum, base, mainnet, mantle, mantleSepoliaTestnet } from 'viem/chains';
import z from 'zod';

export const ALLOWED_CHAINS = [mainnet, arbitrum, base, mantle, mantleSepoliaTestnet] as const;
export const ALLOWED_CHAIN_IDS = [mainnet.id, arbitrum.id, base.id, mantle.id, mantleSepoliaTestnet.id] as const;
