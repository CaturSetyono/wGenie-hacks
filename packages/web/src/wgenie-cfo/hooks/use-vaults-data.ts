...
import { useVaults, usePrices } from '@walletgenie-protocol/react';
...
/**
 * Fetches Mantle vault metadata (APR, TVL) via @walletgenie-protocol/react useVaults() hook.
...
/**
 * Fetches token prices via @walletgenie-protocol/react usePrices() hook.
