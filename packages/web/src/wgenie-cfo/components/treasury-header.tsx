...
export function TreasuryHeader({ chainId, vaultAddress, vaultName }: Props) {
  return (
    <header className="border-b border-white/5 bg-wgenie-black/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        {/* Left: Home link + vault identity */}
        <div className="flex items-center gap-3">
          <Link
            href="/"
            className="p-1.5 rounded-md hover:bg-white/5 transition-colors text-wgenie-muted hover:text-white"
          >
